...
def load_dataset():
    ...
    print(f' - Max train sequence length: {train_dataset.get_max_length()}')
    print(f' - Max dev sequence length: {dev_dataset.get_max_length()}')
    print(f' - Max test sequence length: {test_dataset.get_max_length()}')
...
class PennTreeBank (data.Dataset):
    ...
    def get_max_length(self):
        longest_sequence = max(self.source, key=lambda seq: len(seq))
