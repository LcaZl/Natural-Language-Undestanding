...
if __name__ == "__main__":
    ...
    subj_model, subj_training_report, best_report, losses = experiment(training_parameters['Subj_model'])
    ...
    pol_model, pol_training_report, best_report, losses = experiment(training_parameters['polarity_model'])
    ...
    pol2_model, pol2_training_report, best_report, losses = experiment(training_parameters['polarity_model_no_obj'])
